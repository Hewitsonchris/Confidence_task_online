...
export default class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.origin = new Phaser.Geom.Circle(0, 0, CENTER_SIZE_RADIUS)
      ...
      this.sense = 1 //sensitivity of slider to arrow key press
    ...
    instruct_txts['instruct_basic'] =
        ...
        'After each reach, you will be asked to rate how confident you are that where you reach will result in a target hit using the arrows on your keyboard to control the bar on the colored rating scale. Up is higher confidence, in [color=#00ff00]green[/color], down is lower confidence in [color=#ff0000]red[/color]. \n
        Once you've set your confidence rating, press the enter key to register your rating. \n
      ...
      `Now, use your keyboard arrows to rate how confident you are that where you reach will result in a target hit. Up is higher confidence, in [color=#00ff00]green[/color], down is lower confidence in [color=#ff0000]red[/color]. \n
      Once you've set your confidence rating, press the enter key to register your rating.`
